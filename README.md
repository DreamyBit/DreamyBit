[![GitHub Banner](./banner.jpg)](https://github.com/DreamyBit)
...
He logrado modelar y mantener estable un servicio que alimenta el sistema de salud de todo el país.

En mi tiempo libre, continúo expandiendo mi experiencia estudiando arquitectura de software, enfocándome en diseñar sistemas robustos y mantenibles que puedan escalar con las crecientes necesidades del negocio.

Siempre estoy abierto a conectar con otros desarrolladores y discutir tecnología, mejores prácticas y soluciones innovadoras.


## Contacto
**Email:** felipe.ims@outlook.es

[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/felipe-mu%C3%B1oz-sanchez-010634262/) 
...
**Servicios AWS:** ECS, Lambda, S3, VPC, API Gateway, CloudWatch, IAM, ALB/NLB, CloudFront, Route 53, Secrets Manager, Parameter Store, SQS, EventBridge, EFS
...
- Modelé e implementé arquitectura para sistemas a nivel nacional, asegurando confiabilidad y escalabilidad del sistema
...
### LandCoverageEE-R
Análisis de uso de suelo utilizando datos del satélite Sentinel 2 a través de Google Earth Engine, exportando rasters compatibles con sistemas capaces de realizar proyecciones regresivas.
