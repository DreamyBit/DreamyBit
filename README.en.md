...
I've achieved modeling and keeping stable a service that feeds the healthcare of the whole country.

In my spare time, I'm continuously expanding my expertise by studying software architecture, focusing on designing robust and maintainable systems that can scale with growing business needs.

I'm always open to connecting with fellow developers and discussing technology, best practices, and innovative solutions.
...
**AWS Services:** ECS, Lambda, S3, VPC, API Gateway, CloudWatch, IAM, ALB/NLB, CloudFront, Route 53, Secrets Manager, Parameter Store, SQS, EventBridge, EFS
...
- Modeled and implemented architecture for countrywide systems, ensuring system reliability and scalability
